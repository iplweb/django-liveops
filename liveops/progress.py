...
class WebProgress(Progress):
    ...
    def swap(self, selector: str, name: Optional[str] = None, **ctx: Any) -> None:
        ...
        if raw is not None:
            ...
            from liveops.naming import class_to_snake
    ...
    def _push_stages_fragment(self) -> None:
        ...
        op = self._operation
        inner = self._render("liveops/_stages.html", {"op": op})
    ...
    def chain_to(self, next_op: Any) -> None:
        ...
        from liveops.runner import enqueue
    ...
    def push_cancelled(self) -> None:
        ...
        def _do_push() -> None:
            inner = render_fn("liveops/_cancelled.html", {"op": op})
            push_fn(f'<div id="op-result" hx-swap-oob="true">{inner}</div>')
    ...
    def push_error(self) -> None:
        ...
        def _do_push() -> None:
            push_fn(render_fn("liveops/_error.html", {"op": op}))
